...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServiciosAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AuthService = class AuthService {
      ...
      isUserPasajero(userUid, ciudad) {
        return this.db.doc("users/".concat(userUid)).valueChanges();
        return this.db.doc("users/".concat(ciudad)).valueChanges();
      }
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__["AngularFirestore"]])], AuthService);
    /***/
  },
  ...
  /***/
  function srcAppServiciosGuiasServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GuiasService", function () {
      return GuiasService;
    });
    /* harmony import */
    ...
    let GuiasService = class GuiasService {
      constructor(afs) {
        ...
        this.guiaCollection = afs.collection('guias');
        this.guias = this.guiaCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => actions.map(a => {
    ...
    GuiasService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]])], GuiasService);
    /***/
  },
  ...
  /***/
  function srcAppServiciosMainServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    let MainService = class MainService {
      constructor(afs) {
        ...
        this.mainCollection = afs.collection('Tours');
        this.main = this.mainCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => actions.map(a => {
          const data = a.payload.doc.data();
          const id = a.payload.doc.id;
          return Object.assign({
            id
    ...
    MainService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]])], MainService);
    /***/
  }
}]);
